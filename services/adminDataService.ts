...
const ESSENTIAL_USERS: UserProfile[] = [
    ...
    { id: 'SUP', name: 'National Supervisor', firstName: 'National', lastName: 'Supervisor', email: 'supervisor@moa.gov.sz', role: UserRole.Government, actorType: ActorType.Gov, region: Region.All, status: 'Active', title: 'National Hub Monitor', organization: 'Ministry of Agriculture', organizationId: 'MOA-HQ', country: 'Eswatini' },
